...
\begin{dfn}[\textbf{半平面上}\index{はんへいめん@半平面}・\textbf{へり}\index{へり@へり（半平面の）}・\textbf{同じ側}\index{おなじがわ@同じ側}]
...
\begin{dfn}[\textbf{共役な半平面上}\index{きょうやくなはんへいめん@共役な半平面上}・\textbf{へり}\index{へり@へり（共役な半平面の）}・\textbf{反対側}\index{はんたいがわ@反対側}]\label{260502235601}
